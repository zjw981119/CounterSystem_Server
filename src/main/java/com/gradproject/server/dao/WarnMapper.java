...
public interface WarnMapper {
    ...
    @Select({"<script>"
            ...
            +"(((count(gn_self_counter.transport_distance)+SUM(gn_self_counter.addcar_particular)) *  re_car_config.multiple) * ((count(gn_self_counter.transport_distance)+SUM(gn_self_counter.addcar_particular)) *  re_car_config.multiple)) as fang ,re_car_config.jishi,((count(gn_self_counter.transport_distance)+SUM(gn_self_counter.addcar_particular)) * re_car_config.oil_price) as mei,(((count(gn_self_counter.transport_distance)+SUM(gn_self_counter.addcar_particular)) * re_car_config.oil_price) + jishi + ((count(gn_self_counter.transport_distance)+SUM(gn_self_counter.addcar_particular)) *  re_car_config.oil_price  * re_car_config.multiple)) as mao, "
            +"sum(re_car_production.oil_L) as oil_L,(re_car_config.oil_price * sum(re_car_production.oil_L)) as ran "
            +"FROM gn_self_counter,re_car_config,re_car_production "
            +"<where>"
            ...
            +"and  date_format(time,'%Y-%m-%d') = re_car_config.date "
            +"and re_car_config.type = '内部' "
            +"</where>"
            +"GROUP BY gn_self_counter.transport_distance,re_car_production.oil_L,re_car_config.car_id  "
            +"UNION "
            +"SELECT "
