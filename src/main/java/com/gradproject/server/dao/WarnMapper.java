...
public interface WarnMapper {
    ...
    @Select({"<script>"
            ...
            +"UNION "
            +"SELECT "
            +"car_type,car_id,(sum(num )) as tripNum, oil_price, "
            +" yun,beilv,((sum(num )) * oil_price * beilv) as zhuang, ((sum(num )) * beilv) as biao, "
            +" (((sum(num )) * beilv) * ((sum(num )) * oil_price * beilv)) as fang, sum(jishishijian*jishidanjia) as jishi,((sum(num )) * oil_price) as mei,(sum(jishishijian*jishidanjia) + ((sum(num )) * oil_price) + ((sum(num )) * oil_price * beilv)) as mao, "
            ...
            +"("
            +"SELECT "
            +"(sum(num )) as c,oil_price,"
            +"yun,beilv,((sum(num )) * oil_price * beilv) as z,((sum(num )) * beilv) as b,"
            +"(((sum(num )) * beilv) * ((sum(num )) * oil_price * beilv)) as f,sum(jishishijian*jishidanjia) as j,((sum(num )) * oil_price) as m,(sum(jishishijian*jishidanjia) + ((sum(num )) * oil_price) + ((sum(num )) * oil_price * beilv)) as ma,"
